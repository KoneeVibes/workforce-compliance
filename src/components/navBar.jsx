...
const Navbar = () => {
  ...
  return (
    <div className="bg-[#F0EDE6] px-4 pt-4 sticky top-0 z-50">
      <nav className="flex items-center justify-between px-3 py-2 max-w-6xl mx-auto border border-[#1a1a1a]/10 rounded-full bg-[#F0EDE6]">
        {/* Logo */}
      ...
      {/* Mobile Menu */}
      {isOpen && (
        <div className="lg:hidden mt-2 max-w-6xl mx-auto border border-[#1a1a1a]/10 rounded-2xl bg-[#F0EDE6] px-6 py-4 flex flex-col items-center gap-4">
