...
const Hero = () => {
	...
	return (
		<div className="bg-[#F0EDE6] px-4 py-4">
			<div className="relative max-w-[1280px] mx-auto rounded-3xl overflow-hidden">
				{/* Background Image */}
				<img
					src={heroBg}
					alt="hero background"
				...
				{/* Content */}
				<div className="relative z-10 flex flex-col justify-center h-full px-6 sm:px-10 md:px-14 py-16 sm:py-20">
					{/* Heading */}
