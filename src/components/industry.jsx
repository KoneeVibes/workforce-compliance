      ...
      <div className="max-w-6xl mx-auto">
        <div className="flex flex-col lg:flex-row items-start justify-between gap-12 mb-16">
          <div className="flex flex-col gap-4">
            ...
            <h2 className="text-4xl sm:text-5xl font-semibold text-[#1B412A] leading-tight max-w-sm">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-x-16">
          <div>
            {leftIndustries.map((industry) => (
              <div
                key={industry}
                className="flex items-center justify-between py-4 border-t border-[#1a1a1a]/10 group cursor-pointer"
              >
